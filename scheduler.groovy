...
regEx9= />[a-zA-Z]{4}</// Pulls out DEPT
regEx8 = />[0-9]{3}</// Pulls out course #
regEx10 = />[0-9]{2}</// Prints out section
regEx11 = />[0-9]{5}</// Prints out CRN #
...
// Create an instance of schedule for the user
